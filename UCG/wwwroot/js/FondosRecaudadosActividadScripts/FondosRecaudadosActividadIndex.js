$(document).ready(function () {
    ...
    $('#miTabla tbody').on('click', 'tr', function () {
        var idFRA = $(this).data("id"); // Obtener ID de la fila seleccionada
        console.log("ID MovimientoEgreso:", idFRA);

        if (idFRA) {
            window.location.href = "/TbFondosRecaudadosActividads/Details/" + idFRA;
        }
    });
